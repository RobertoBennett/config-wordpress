...
define('WP_REDIS_READ_TIMEOUT', 1);     // Таймаут чтения
define('WP_REDIS_DATABASE', 0);         // Используйте БД Redis 0 (по умолчанию)
define('WP_REDIS_MAXTTL', 86400); 
define('WP_REDIS_HOST', '127.0.0.1');  
define('WP_REDIS_PORT', '6379');  
define('WP_CACHE_KEY_SALT', 'site.ru');  
define('WP_MAX_MEMORY_LIMIT', '4000M');
define('WP_CACHE_EXPIRE', 3600);
define('XMLRPC_ENABLED', false);
define('WP_MEMORY_LIMIT', '3200M');
